    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="https:/mentaya.shop/" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator, Saat ini anda menggunakan app Mentaya Online Marketplace</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://mentaya.shop/" style="color: rgb(243, 156, 18);">Marketplace 1.0</a>
        </div>
      <?php } ?>
